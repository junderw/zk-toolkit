use crate::building_block::{
    curves::bls12_381::{
        fq12::Fq12, g1_point::G1Point, g2_point::G2Point, params::Params as P,
...
mod tests {
    ...
    fn test_with_generators(pair: &dyn Fn(&Pairing, &G1Point, &G2Point) -> Fq12) {
    ...
    fn test_with_random_points(pair: &dyn Fn(&Pairing, &G1Point, &G2Point) -> Fq12) {
        let mut errors = 0;
        let num_tests = 1;
