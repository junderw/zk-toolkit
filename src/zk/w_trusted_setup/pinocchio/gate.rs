...
mod tests {
    ...
    fn test_build_sub() {
        ...
        assert_eq!(
            gates[0].a,
            Term::Sum(Box::new(Term::Num(f.elem(&4u8))), Box::new(Term::TmpVar(1)))
        );
        assert_eq!(gates[0].b, Term::One);
    ...
    fn test_build_combined1() {
        ...
        assert_eq!(
            gates[1].a,
            Term::Sum(Box::new(Term::TmpVar(1)), Box::new(Term::Num(f.elem(&4u8))))
        );
        assert_eq!(gates[1].b, Term::One);
    ...
    fn test_build_combined2() {
        ...
        assert_eq!(
            gates[3].a,
            Term::Sum(Box::new(Term::TmpVar(2)), Box::new(Term::TmpVar(3)))
        );
        assert_eq!(gates[3].b, Term::One);
