use crate::{
    building_block::{
        curves::bls12_381::{g1_point::G1Point, g2_point::G2Point, pairing::Pairing},
        zero::Zero,
    },
    zk::w_trusted_setup::pinocchio::{
        crs::CRS, pinocchio_proof::PinocchioProof, sparse_vec::SparseVec,
    },
};
...
impl PinocchioVerifier {
    pub fn new() -> Self {
        ...
        PinocchioVerifier { pairing }
    }

    pub fn verify(&self, proof: &PinocchioProof, crs: &CRS, witness_io: &SparseVec) -> bool {
